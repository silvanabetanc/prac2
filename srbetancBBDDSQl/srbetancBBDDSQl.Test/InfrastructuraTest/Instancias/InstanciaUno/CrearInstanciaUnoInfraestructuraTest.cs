...
{
    public class CrearInstanciaUnoInfraestructuraTest
    {
        ...
        public void Setup()
        {
            ...
            _mockiInstanciaUnoRepositorio.Setup(x => x.EjecutarCrearInstancia(It.IsAny<EEntrada<EHistorialEvento>>())).ReturnsAsync(It.IsAny<ERespuesta<EFrmHistorialEvento>>());
        }
        ...
        public void Obtener_Consulta_Instacia_Retorna_ListaObjeto()
        {
            ...
            //Act 
            var respuesta = _iInstanciaUnoInfraestructura.EjecutarCrearInstancia(_dataEntrada._HistoricoEvento);
            //Assert
